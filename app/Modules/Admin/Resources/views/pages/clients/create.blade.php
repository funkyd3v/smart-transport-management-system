...
@section('title', 'Admin - Clients / Create')

@section('content')
 <x-common.page-breadcrumb pageTitle="Clients / Create" />
 ...
 <h2 class="mt-2 text-xl font-semibold text-slate-900">Clients / Create</h2>
