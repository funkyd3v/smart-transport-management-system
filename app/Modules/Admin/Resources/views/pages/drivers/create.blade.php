...
@section('title', 'Admin - Drivers / Create')

@section('content')
 <x-common.page-breadcrumb pageTitle="Drivers / Create" />
 ...
 <h2 class="mt-2 text-xl font-semibold text-slate-900">Drivers / Create</h2>
