<div class="relative" x-data="{
 ...
 <!-- User Info -->
 <div>
 <span class="block font-medium text-gray-700 text-theme-sm">Musharof Chowdhury</span>
 <span class="mt-0.5 block text-theme-xs text-gray-500">randomuser@pimjo.com</span>
 </div>
 ...
 <button
 type="submit"
 class="flex items-center w-full gap-3 px-3 py-2 mt-3 font-medium text-left text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700"
 @click="closeDropdown()"
 >
 <span class="text-gray-500 group-hover:text-gray-700">
