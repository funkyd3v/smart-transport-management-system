<x-common.component-card title="Textarea input fields">
 ...
 class=" shadow-theme-xs focus:border-brand-300 focus:shadow-focus-ring w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-0 focus:outline-hidden disabled:border-gray-100 disabled:bg-gray-50 disabled:placeholder:text-gray-300"></textarea>
 </div>
 ...
 <textarea placeholder="Enter a description..." type="text" rows="6"
 class=" border-error-300 shadow-theme-xs focus:border-error-300 focus:ring-error-500/10 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden"></textarea>
