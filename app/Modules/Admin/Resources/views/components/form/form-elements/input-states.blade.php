<x-common.component-card  title="Input States"
...
>
 ...
 class=" border-error-300 shadow-theme-xs focus:border-error-300 focus:ring-error-500/10 w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden" />
 ...
 class=" border-success-300 shadow-theme-xs focus:border-success-300 focus:ring-success-500/10 w-full rounded-lg border bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden" />
 <span class="absolute top-1/2 right-3.5 -translate-y-1/2">
 <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
 xmlns="http://www.w3.org/2000/svg">
 <path fill-rule="evenodd" clip-rule="evenodd"
