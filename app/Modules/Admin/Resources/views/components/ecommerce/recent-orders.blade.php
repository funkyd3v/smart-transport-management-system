...
@php
 ...
 $baseClasses = 'rounded-full px-2 py-0.5 text-theme-xs font-medium';
  return match($status) {
 'Delivered' => $baseClasses . ' bg-success-50 text-success-600',
 'Pending' => $baseClasses . ' bg-warning-50 text-warning-600',
 'Canceled' => $baseClasses . ' bg-error-50 text-error-600',
 default => $baseClasses . ' bg-gray-50 text-gray-600',
 };
 };
@endphp
...
<div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 sm:px-6">
 ...
 <button class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800">
 ...
 <p class="font-medium text-gray-500 text-theme-xs">Products</p>
 </th>
 <th class="py-3 text-left">
 <p class="font-medium text-gray-500 text-theme-xs">Category</p>
 </th>
 <th class="py-3 text-left">
 <p class="font-medium text-gray-500 text-theme-xs">Price</p>
 </th>
 <th class="py-3 text-left">
 ...
 <td class="py-3 whitespace-nowrap">
 <p class="text-gray-500 text-theme-sm">{{ $product['category'] }}</p>
 </td>
 <td class="py-3 whitespace-nowrap">
 <p class="text-gray-500 text-theme-sm">{{ $product['price'] }}</p>
 </td>
 <td class="py-3 whitespace-nowrap">
