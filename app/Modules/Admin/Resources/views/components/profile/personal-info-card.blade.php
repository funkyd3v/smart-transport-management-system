<div x-data="{saveProfile(){
 ...
 <div>
 <p class="mb-2 text-xs leading-normal text-gray-500">First Name</p>
 <p class="text-sm font-medium text-gray-800">Musharof</p>
 </div>

 <div>
 <p class="mb-2 text-xs leading-normal text-gray-500">Last Name</p>
 <p class="text-sm font-medium text-gray-800">Chowdhury</p>
 </div>
 ...
 <div>
 <p class="mb-2 text-xs leading-normal text-gray-500">Phone</p>
 <p class="text-sm font-medium text-gray-800">+09 363 398 46</p>
 </div>
