<div x-data="{saveProfile(){
 ...
 <div>
 <h4 class="text-lg font-semibold text-gray-800 lg:mb-6">Address</h4>

 <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
 <div>
 <p class="mb-2 text-xs leading-normal text-gray-500">Country</p>
 <p class="text-sm font-medium text-gray-800">United States</p>
 </div>

 <div>
 <p class="mb-2 text-xs leading-normal text-gray-500">City/State</p>
 ...
 <p class="text-sm font-medium text-gray-800">ERT 2489</p>
 </div>

 <div>
 <p class="mb-2 text-xs leading-normal text-gray-500">TAX ID</p>
 <p class="text-sm font-medium text-gray-800">AS4568384</p>
 </div>
 </div>
 </div>
 ...
 class=" h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10" />
 </div>
