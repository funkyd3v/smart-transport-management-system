<div x-data="{
 ...
 :class="selectAll ? 'border-blue-500 bg-blue-500' : 'bg-white border-gray-300'">
 ...
 <span class="font-medium text-gray-500 text-theme-xs">Deal ID</span>
 </div>
 </th>
 <th class="px-6 py-3 font-medium text-gray-500 sm:px-6 text-theme-xs text-start">Customer</th>
 <th class="px-6 py-3 font-medium text-gray-500 sm:px-6 text-theme-xs text-start">Product/Service</th>
 <th class="px-6 py-3 font-medium text-gray-500 sm:px-6 text-theme-xs text-start">Deal Value</th>
 <th class="px-6 py-3 font-medium text-gray-500 sm:px-6 text-theme-xs text-start">Close Date</th>
 <th class="px-6 py-3 font-medium text-gray-500 sm:px-6 text-theme-xs text-start">Status</th>
 <th class="px-6 py-3 font-medium text-gray-500 sm:px-6 text-theme-xs text-start">Action</th>
 </tr>
 </thead>
 <tbody>
 ...
 class="flex h-5 w-5 cursor-pointer items-center justify-center rounded-md border-[1.25px]"
 :class="selectedRows.includes(row.id) ? 'border-blue-500 bg-blue-500' : 'bg-white border-gray-300'">
 ...
 <div>
 <span class="block font-medium text-gray-700 text-theme-sm" x-text="row.id"></span>
 </div>
 </div>
 </td>
 <td class="px-4 sm:px-6 py-3.5">
 ...
 <div>
 <span class="mb-0.5 block text-theme-sm font-medium text-gray-700" x-text="row.customerName"></span>
 <span class="text-gray-500 text-theme-sm" x-text="row.customerEmail"></span>
 </div>
 </div>
 </td>
 <td class="px-4 sm:px-6 py-3.5">
 <p class="text-gray-700 text-theme-sm" x-text="row.product"></p>
 </td>
 <td class="px-4 sm:px-6 py-3.5">
 <p class="text-gray-700 text-theme-sm" x-text="row.value"></p>
 </td>
 <td class="px-4 sm:px-6 py-3.5">
 <p class="text-gray-700 text-theme-sm" x-text="row.closeDate"></p>
 </td>
 <td class="px-4 sm:px-6 py-3.5">
 <span class="text-theme-xs inline-block rounded-full px-2 py-0.5 font-medium"  :class="getStatusClass(row.status)"  x-text="row.status"></span>
 </td>
 <td class="px-4 sm:px-6 py-3.5">
 <button @click="deleteRow(row.id)">
 <svg class="text-gray-700 cursor-pointer size-5 hover:text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
