...
>
 ...
 <p class="font-medium text-gray-500 text-theme-xs">Country</p>
 </div>
 </th>
 <th class="px-6 py-3">
 <div class="flex items-center col-span-2">
 <p class="font-medium text-gray-500 text-theme-xs">CR</p>
 </div>
 </th>
 <th class="px-6 py-3">
 <div class="flex items-center col-span-2">
 <p class="font-medium text-gray-500 text-theme-xs">Value</p>
 </div>
 </th>
 </tr>
 </thead>
 ...
 <td class="px-6 py-3.5">
 <div class="flex items-center">
 <p class="text-gray-500 text-theme-sm">{{ $order['category'] }}</p>
 </div>
 </td>
 <td class="px-6 py-3.5">
 <div class="flex items-center">
